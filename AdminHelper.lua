...
function main()
	...
	if configIni == nil or statsIni == nil or filterIni == nil or announceIni == nil or binderIni == nil or penaltyIni == nil or farchatIni == nil or bindsIni == nil or warningsIni == nil then
	...
	while true do
		...
		if var_0_82.menu.v or var_0_82.changename.v or var_0_82.acar.v or var_0_82.ahgun.v or var_0_82.mpwin.v or var_0_82.cheats.v or var_0_82.bans.v or var_0_82.fastreport.v or var_0_82.rtools.v or var_0_82.myskin.v or var_0_82.stats.v or var_0_82.ears.v or var_0_82.vip_fastad.v or var_0_82.spectatemenu.v or var_0_82.makeleader.v or var_0_82.templeader.v or var_0_82.scoreboard.v then
		...
		if configIni.config.clickwarp and var_0_82.menu.v == false and var_0_82.changename.v == false and var_0_82.acar.v == false and var_0_82.ahgun.v == false and var_0_82.mpwin.v == false and var_0_82.cheats.v == false and var_0_82.bans.v == false and var_0_82.fastreport.v == false and var_0_82.rtools.v == false and var_0_82.myskin.v == false and var_0_82.stats.v == false and var_0_82.ears.v == false and var_0_82.vip_fastad.v == false and var_0_82.spectatemenu.v == false and var_0_82.makeleader.v == false and var_0_82.templeader.v == false and var_0_82.scoreboard.v == false then
			warptp()
		end
...
function var_0_3.OnDrawFrame()
	if var_0_82.menu.v then
		...
		if var_0_82.settings.v then
			...
			if var_0_117 == 1 then
				if var_0_3.Checkbox(u8("[Beta] Scoreboard (Tab) \xF1 \xEB\xEE\xE3\xEE\xEC \xEF\xEE\xE4\xEA\xEB\xFE\xF7\xE5\xED\xE8\xE9"), checks.scoreboard) then
					configIni.config.scoreboard = checks.scoreboard.v

					var_0_2.save(configIni, "AdminHelper/config")
				end

				ShowWarningMarker("Beta \xF4\xF3\xED\xEA\xF6\xE8\xFF\n\xC6\xF0\xE5\xF2 FPS, \xEA\xEE\xE3\xE4\xE0 \xEE\xF2\xEA\xF0\xFB\xF2\xEE,\n\xED\xE5 \xF0\xE5\xEA\xEE\xEC\xE5\xED\xE4\xF3\xE5\xF2\xF1\xFF \xEA \xE8\xF1\xEF\xEE\xEB\xFC\xE7\xEE\xE2\xE0\xED\xE8\xFE \xED\xE0 \xF1\xEB\xE0\xE1\xFB\xF5 \xCF\xCA")
